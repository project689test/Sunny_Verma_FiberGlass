...
const ContactPage = () => {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-gray-50 border-t border-[rgba(0,195,255,0.05)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} viewport={{ once: true }}>
              <motion.h2 variants={fadeInUp} className="text-3xl font-heading font-bold text-gray-900 mb-6">
              ...
              <div className="space-y-6">
                <motion.div variants={fadeInUp} className="glass-card p-6 flex items-start border-[rgba(0,195,255,0.15)] group hover:border-[rgba(0,195,255,0.4)]">
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-gray-900 text-lg mb-1 tracking-wide">Office Address</h4>
                ...
                <motion.div variants={fadeInUp} className="glass-card p-6 flex items-start border-[rgba(0,195,255,0.15)] group hover:border-[rgba(255,140,0,0.4)]">
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-gray-900 text-lg mb-1 tracking-wide">Phone Number</h4>
                ...
                <motion.div variants={fadeInUp} className="glass-card p-6 flex items-start border-[rgba(0,195,255,0.15)] group hover:border-[rgba(0,195,255,0.4)]">
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-gray-900 text-lg mb-1 tracking-wide">Email Address</h4>
            ...
            >
              <h3 className="text-2xl font-heading font-bold text-gray-900 mb-6 tracking-wide">Send a Message</h3>
