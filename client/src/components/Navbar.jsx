    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {/* Desktop Phone Contact & Theme Toggle */}
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button 
              onClick={toggleTheme}
              className="p-2.5 rounded-full bg-white text-gray-900 border border-gray-200 shadow-sm hover:bg-gray-100 transition-colors focus:outline-none flex items-center justify-center min-w-[40px] dark-theme-override"
              aria-label="Toggle Theme"
              style={{
                backgroundColor: theme === 'dark' ? '#ffffff' : '#091020',
                color: theme === 'dark' ? '#091020' : '#ffffff',
                borderColor: theme === 'dark' ? '#e5e7eb' : 'rgba(0,195,255,0.15)'
              }}
            >
              {theme === 'dark' ? (
        ...
        {isOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <div className="pt-4 pb-2 border-t border-[rgba(0,195,255,0.15)] mt-2 flex flex-col gap-4">
                ...
                <div className="px-3">
                  <button 
                    onClick={toggleTheme}
                    className="flex items-center gap-2 px-4 py-2 rounded-md w-full border font-medium focus:outline-none transition-colors"
                    style={{
                      backgroundColor: theme === 'dark' ? '#ffffff' : '#091020',
                      color: theme === 'dark' ? '#091020' : '#ffffff',
                      borderColor: theme === 'dark' ? '#e5e7eb' : 'rgba(0,195,255,0.15)'
